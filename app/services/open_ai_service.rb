...
class OpenAiService
  ...
  def build_prompt
    <<~PROMPT
      Generate a round-trip itinerary between #{@sloopy.origin} and #{@sloopy.destination} for a trip from #{@sloopy.departure_date}, to #{@sloopy.return_date}, with a maximum transport budget of #{@sloopy.budget}.
